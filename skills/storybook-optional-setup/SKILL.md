---
name: storybook-optional-setup
description: Use only when the user explicitly wants Storybook or component documentation tooling. Do not add Storybook automatically.
---
